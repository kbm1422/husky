...
if sys.version_info.major >= 3:
    ...
    from xmlrpc.server import MultiPathXMLRPCServer as BaseMultiPathXMLRPCServer
else:
    from xmlrpclib import ServerProxy, Transport
    from SocketServer import ThreadingMixIn
    from SimpleXMLRPCServer import SimpleXMLRPCServer, SimpleXMLRPCDispatcher, resolve_dotted_attribute
    from SimpleXMLRPCServer import MultiPathXMLRPCServer as BaseMultiPathXMLRPCServer
