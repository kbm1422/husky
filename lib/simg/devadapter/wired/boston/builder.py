...
class BostonLibBuilder(object):
    ...
    def copy_dll_and_pym_to_current_dir(self):
        current_dir = os.path.dirname(__file__)
        fs.copy(self.__dll_path, current_dir)
        fs.copy(self.__pym_path, current_dir)
...
"""
    ...
    def build_all(self):
        self.copy_source_to_project_dir()
        self.copy_multi_device_on_one_machine_implementation_to_project_dir()
        self.build_def().build_header().build_dll().build_python_module()
        self.copy_dll_and_pym_to_current_dir()
